        ...
        <div className="space-y-8 p-8">
            ...
            {(analyticsData) ? (
                <>
                    ...
                    />
                    <ChartDashboardQuickInsights analyticsData={analyticsData} granularity={granularity} />
...
function DashBoardSettings({ dateRange, setGranularity, granularity, setDateRange, updateAnalyticsData, updateDaterange }: DashBoardSettingsProps) {
    return <div>
...
function ChartDashboardQuickInsights({ analyticsData, granularity }: ChartDashboardViewProps) {
    return <>
